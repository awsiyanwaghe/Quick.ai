import { Edit, SendIcon, Sparkle } from 'lucide-react'
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <input onChange={(e) => setinput(e.target.value)} value={input} type="text" placeholder='The future of artifitial intelligence is...' required
          className='w-full p-2 px-3 mt-2 outline-none text-sm rounded-md border border-gray-300' />
        <p className='mt-3 text-sm font-medium'>Article Lenth</p>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        ...
        {!content ? (
          <div className='flex-1 flex justify-center items-center'>
            <div className='text-sm flex flex-col items-center gap-5 to-gray-400'>
